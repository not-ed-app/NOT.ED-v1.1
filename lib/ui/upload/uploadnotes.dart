...
import 'package:noted_app/ui/upload/dbevent.dart';
    ...
    void validateAndUpload() {
      if (_formKey.currentState.validate()) {
        ...
        if (_image != null && _file != null) {
          ...
          UploadTask task2 = storage.ref().child(pdf).putFile(_file);
          task.then((snapshot) async {
            imageUrl = await snapshot.ref.getDownloadURL();
            task2.then((snapshot) async {
...
Fluttertoast.showToast(msg: 'PDF Added',toastLength: Toast.LENGTH_LONG, gravity: ToastGravity.CENTER,
   ...
   Fluttertoast.showToast(msg: 'PDF Not Added',toastLength: Toast.LENGTH_LONG, gravity: ToastGravity.CENTER,
            backgroundColor: Colors.blue[300],textColor: Colors.white,fontSize: 16.0);
      }
